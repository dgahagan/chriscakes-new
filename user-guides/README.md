# ChrisCakes User Guides

Welcome to the ChrisCakes website management guides! These step-by-step tutorials will help you manage your website content without any technical knowledge.
...
- Using "Call for pricing!" for custom items
...
**Key feature:** Emails from the contact form include a reply-to header, so you can simply click "Reply" in your email program to respond directly to the customer!
...
1. **Make small changes first** - Get comfortable with the system before making major updates
2. **Always click Publish** - Changes aren't live until you publish!
...
- **Studio URL**: www.chriscakesofmi.com/studio
- **Your Website**: www.chriscakesofmi.com
- **Login**: Use your Sanity account credentials

---

**Welcome aboard!** You now have everything you need to manage your ChrisCakes website. Start with the [Getting Started](./GETTING_STARTED.md) guide and you'll be making updates in no time.
